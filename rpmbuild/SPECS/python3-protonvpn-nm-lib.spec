...
%changelog
* Mon Jul 31 2023 Proton Technologies AG <opensource@proton.me> 3.16.0-1
- Fix: Connectivity issues if protonstatus.com is down

* Mon Jul 31 2023 Proton Technologies AG <opensource@proton.me> 3.15.0-1
- Fix: NM plugin not accepting params for newer openvpn version
